...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const injectUIElements = () => {
    ...
    if (printBtnNode) {
        // Ensuring the event listener gets safely attached whether the button was injected or is hardcoded in HTML
  ...
  window.addEventListener('keydown', (e) => {
    if ((e.ctrlKey || e.metaKey) && !e.shiftKey) {
      ...
      if (key === 's') {
        ...
        // Updated to trigger Print Invoice instead of PDF
        e.preventDefault();
